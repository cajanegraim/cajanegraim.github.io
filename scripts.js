...
function verificarAnchoPantalla() {
  ...
  if (anchoPantalla <= 768) {
    header.innerHTML = "<div class='menu-icon' id='menu-icon'><span></span><span></span><span></span></div><div id='header-logo-container'><a href='/index.html'><img src='/img/logo.png' alt=''></a></div><nav><ul class='nav-links'><li><a href='/nosotros.html'>NOSOTROS</a></li><li><a href='/servicios.html'>SERVICIOS</a></li><li class='contacto-link'>CONTACTO</li></ul></nav>";
    ...
    menuIcon.addEventListener("click", () => {
      ...
      if (window.location.pathname != '/index.html' && window.location.pathname != '/') {
        ...
        sidebarLinks.innerHTML = "<li><a href='/index.html'>INICIO</a></li><li><a href='/nosotros.html'>NOSOTROS</a></li><li><a href='/servicios.html'>SERVICIOS</a></li><li class='contacto-link'>CONTACTO</li>";
    ...
    header.innerHTML = "<div id='header-logo-container'><a href='/index.html'><img src='/img/logo.png' alt=''></a></div><nav><ul class='nav-links'><li><a href='/index.html'>INICIO</a></li><li><a href='/nosotros.html'>NOSOTROS</a></li><li><a href='/servicios.html'>SERVICIOS</a></li><li class='contacto-link'>CONTACTO</li></ul></nav>";
  }
}
...
function cambiarIconoSobreFooter() {
  ...
  if (botonRect.bottom > footerRect.top && botonRect.top < footerRect.bottom) {
      ...
      icono.src = "/img/whatsapp-inv.svg";
      text.style.color = "#f2f2f2";
  } else {
      // Volver al ícono original
      icono.src = "/img/whatsapp.svg";
